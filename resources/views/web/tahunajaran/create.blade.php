...
<div class="modal fade" id="tambahTahunAjaranModal" tabindex="-1" role="dialog"
    aria-labelledby="tambahTahunAjaranModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" onclick="location.reload();"><i
