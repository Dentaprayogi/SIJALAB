            ...
            <form action="{{ route('lab.update', $lab->id_lab) }}" method="POST" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <textarea name="fasilitas_lab" class="form-control" required>{{ old('fasilitas_lab', $lab->fasilitas_lab) }}</textarea>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="kapasitas_lab" class="form-control" value="{{ old('kapasitas_lab', $lab->kapasitas_lab) }}" required>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-switch-toggle">
                        <input type="hidden" name="status_lab" id="status_lab_hidden" value="{{ old('status_lab', isset($lab) ? $lab->status_lab : 'nonaktif') }}">
                        <input type="checkbox" id="status_lab_switch" class="switch-toggle" {{ old('status_lab', isset($lab) ? $lab->status_lab : 'nonaktif') == 'aktif' ? 'checked' : '' }}>
                        <label for="status_lab_switch" class="switch-label"></label>
                        <span id="status_lab_text">{{ old('status_lab', isset($lab) ? $lab->status_lab : 'nonaktif') == 'aktif' ? 'Aktif' : 'Nonaktif' }}</span>
                    </div>
                </div>                
