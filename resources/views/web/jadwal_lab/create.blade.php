    ...
    $(document).ready(function() {
        $('#id_prodi').on('change', function() {
            ...
            if (prodiId) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data.mk, function(index, value) {
                            $('#id_mk').append('<option value="'+ value.id_mk +'">'+ value.nama_mk +'</option>');
                        });
    
                        $.each(data.dosen, function(index, value) {
                            $('#id_dosen').append('<option value="'+ value.id_dosen +'">'+ value.nama_dosen +'</option>');
                        });
                ...
                $('#id_kelas').empty().append('<option value="">-- Pilih Kelas --</option>').trigger('change');
                $('#id_mk').empty().append('<option value="">-- Pilih Mata Kuliah --</option>').trigger('change');
                $('#id_dosen').empty().append('<option value="">-- Pilih Dosen --</option>').trigger('change');
            }
        });
    
        // Awal: aktifkan select2
        $('#id_kelas').select2({ placeholder: "-- Pilih Kelas --", allowClear: true });
        $('#id_mk').select2({ placeholder: "-- Pilih Mata Kuliah --", allowClear: true });
        $('#id_dosen').select2({ placeholder: "-- Pilih Dosen --", allowClear: true });
    });
 </script> 
