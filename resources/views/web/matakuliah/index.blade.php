                        ...
                        @else
                            @foreach($matakuliah as $mk)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalEditMatakuliah{{ $mk->id_mk }}">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <form action="{{ route('matakuliah.destroy', $mk->id_mk) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        @if (session('error'))
            Swal.fire({
                ...
                if (oldId) {
                    var editModal = new bootstrap.Modal(document.getElementById('modalEditMatakuliah' + oldId));
                    editModal.show();
                } else {
                    var tambahModal = new bootstrap.Modal(document.getElementById('modalTambahMatakuliah'));
                    tambahModal.show();
                }
            });
        @endif
